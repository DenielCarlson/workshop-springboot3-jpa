...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Order o1 = new Order(null, Instant.parse("2024-03-05T19:20:12-03:00"), u1);
		Order o2 = new Order(null, Instant.parse("2020-04-20T08:25:10Z"), u2);
		Order o3 = new Order(null, Instant.parse("2021-06-20T10:56:20Z"), u1);
